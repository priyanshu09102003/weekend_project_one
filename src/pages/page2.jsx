...
const Page2 = () => {
  ...
  return (
    <div id='section-2' className='bg-white text-center p-16 text-black'>
      <h3 className='text-gray-600 text-xl font-stage'>© 3D WebStudios 2025 | designed and developed by Priyanshu</h3>

      <div  className='mt-25 rotateText'>
        <h1 className='text-[18vw] text-black font-compressed text-center leading-[20vw]'>IMPACTFUL</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[18vw] text-black font-compressed text-center leading-[20vw]'>DESIGN</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[18vw] text-black font-compressed text-center leading-[20vw]'>IS THE</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[18vw] text-black font-compressed text-center leading-[20vw]'>DESIGN</h1>
      </div>
      ...
      <div className='mt-26 flex items-center justify-center scale-66'>
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="2037" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio" className="max-w-full h-auto">
            <g>
                ...
                <g clipPath="url(#96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2)">
                    <g filter="url(#aef381e0-a01b-4767-81f9-2c2e04143cb9_comp-lmyox36t2)">
                        <mask height="45" width="113" y="19" x="803" maskUnits="userSpaceOnUse" style={{maskType:'luminance'}} id="6fdfdaea-c66e-4c33-992f-dbf7b68cfcfc_comp-lmyox36t2" fill="none">
      ...
      <div className='h-0.5 w-1/3 relative left-1/2 -translate-x-1/2 bg-gray-700 mt-30'>
